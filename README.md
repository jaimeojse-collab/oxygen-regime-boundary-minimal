...
Results suggest that system behavior may separate into recoverable and non-recoverable regimes, separated by an operational boundary in the joint space of load and timescale.
